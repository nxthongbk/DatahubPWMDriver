...
#define AIR_NAME "pwm/channel1/value"

#define PERIOD_NAME "pwm/period"
#define ENABLE_NAME "pwm/enable"
...
)
{
	...
	io_PushNumeric(AIR_NAME, IO_NOW, count);
}
...
COMPONENT_INIT
{
	...
	result = io_CreateInput(AIR_NAME, IO_DATA_TYPE_NUMERIC, "degrees");
